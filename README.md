...
* [Оригинальный запрос видов транспорта]()
* [Изменённый запрос видов транспорта]()
* [Настройка автозамены запроса видов транспорта]()
* [Оригинальный запрос расчёта стоимости поездки]()
* [Изменённый запрос расчёта стоимости поездки]()
* [Настройка автозамены с запросом стоимости длительности поездки]()
---
📝 **Яндекс Маршруты**
1. Диаграмма связей
